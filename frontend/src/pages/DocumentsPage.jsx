       ...
       <Card>
         <div className="invoice-help">
           <div>
             ...
             <p>
               Create a sale first. The system saves the transaction, reduces stock, assigns an invoice number, and immediately offers PDF preview and download.
             </p>
           </div>
         </div>
       </Card>
     ...
     >
       <form onSubmit={save}>
         ...
         <div className="line-items">
             ...
             return (
               ...
               >
                 ...
                 >
                   ...
                   >
                     {selectedProduct
                       ? `${selectedProduct.sku} — ${selectedProduct.name}${isSale ? ` (Stock ${selectedProduct.current_stock})` : ''}`
                       : 'Select product'}
                   </button>
           ...
           {!form.items.length && (
             <div className="empty">
               Add at least one product to generate an invoice.
             </div>
           )}
     ...
     >
       {invoiceReady && (
         <div className="invoice-ready">
           ...
           <div className="invoice-ready-number">
             {invoiceReady.invoice_no}
           </div>

           <p>
             The sale is saved, stock has been updated, and your English-only PDF invoice is ready.
           </p>
