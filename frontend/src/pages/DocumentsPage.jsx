        ...
        <Card>
          <div className="invoice-help">
            <div>
              ...
              <p>
                Create a sale first. The
                system saves the transaction,
                reduces stock, assigns an
                invoice number, and immediately
                offers PDF preview and download.
              </p>
            </div>
          </div>
        </Card>
        ...
        {invoiceReady && (
          <div className="invoice-ready">
            ...
            <p>
              ...
              and your English-only
              PDF invoice is ready.
            </p>
